...
register_command_handler(avipe_call, 'антивайп', ['все', 'админ'], 20, 'Включение/отключение функции защиты от вайп атак. Способно защитить от примитивных и средних атак. По умолчанию включен.', 'антивайп [<1/on/вкл/0/off/выкл>]', ['антивайп on','антивайп off'])
